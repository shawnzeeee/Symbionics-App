...
class CalibrationService:
    ...
    def begin_calibration(self):
        ...
        if muselsl_thread.is_alive() and muselsl_start_event.is_set() and self.pylsl_thread.is_alive and self.pylsl_start_event.is_set():
    ...
    async def begin_checking_signal(self, websocket, file_name: str):
